...
This first version of \textbf{getThermo} is applicable only to frequencies calculations from GAMESS package (\textit{General Atomic and Molecular Electronic Structure System}) \cite{Schmidt1993}. We are planning to expand to Gaussian09 soon.
